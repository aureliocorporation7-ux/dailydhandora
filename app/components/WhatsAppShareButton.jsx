...
export default function WhatsAppShareButton({ article }) {
  const [shareUrl, setShareUrl] = useState('');

  useEffect(() => {
    // Encode the text and URL for the WhatsApp link
  ...
  return (
    <button 
      onClick={handleClick}
      className="w-full flex items-center justify-center gap-3 rounded-lg bg-whatsapp-green text-white font-bold py-4 text-lg hover:bg-green-700 transition-colors"
    >
