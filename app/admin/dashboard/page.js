      ...
      <main className="lg:ml-72">
        ...
        <div className="p-6 max-w-7xl mx-auto">
          {activeView === 'ai-settings' ? (
            ...
            <>
              {/* 🔴 BOT STATUS PANEL - Divine Level Feature */}
              <BotStatusPanel />
              ...
              {/* ⚡ QUICK ACTIONS - Divine Level Feature */}
              <QuickActions onRefresh={() => { fetchArticles(); fetchStats(); }} />

              {/* Main Content Grid with Activity Feed */}
              <div className="grid grid-cols-1 xl:grid-cols-4 gap-6">
                {/* Left Side - Stats and Articles (3 cols) */}
                ...
                {/* Right Side - Activity Feed (1 col) */}
