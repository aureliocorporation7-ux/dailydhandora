                ...
                <div className="bg-[#111] border border-white/10 rounded-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto shadow-2xl">
                    <form onSubmit={saveArticle} className="p-6 space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div><label className="block text-xs font-bold text-gray-500 uppercase mb-1">Category</label><select value={editingArticle.category} onChange={(e) => handleEditChange('category', e.target.value)} className="w-full bg-black border border-white/10 rounded-lg p-3 text-white focus:border-blue-500 outline-none"><option value="Other">Other</option><option value="सरकारी योजना">सरकारी योजना</option><option value="नौकरियां">नौकरियां</option><option value="मंडी भाव">मंडी भाव</option><option value="शिक्षा">शिक्षा</option><option value="राजस्थान">राजस्थान</option></select></div>
